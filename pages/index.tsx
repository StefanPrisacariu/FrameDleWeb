...
export default function Home() {
    ...
    return (
        <>
            ...
            />
            <h1 style={{ display: "none" }}>Welcome to FrameDle!</h1>
                        ...
                        <>
                            ...
                            <div className={Container.fd_container_1}>
                                    ...
                                    <div className={Group.fd_group_0_wrap}>
                                        {yesterdayWf && (
                                            <Image
                                                ...
                                                height={50}
                                                className={
                                                    Group.fd_group_0_wrap_image
                                                }
                                                src={
                                                    yesterdayWf.image as string
                                                }
                                ...
                                <div className={ImgStyle.fd_imgstyle_0}>
                                    {isGuessed ? (
                                        <Image
                                            ...
                                            height={130}
                                            className={
                                                ImgStyle.fd_imgstyle_0_guessed
                                            }
                                            src={todaysWf.image}
                                            alt={todaysWf.name}
                                        />
                                ...
                                <div className={Group.fd_group_0}>
                                    ...
                                    <div className={Group.fd_group_0_wrap_2}>
                                        <span
                                            className={
                                                Group.fd_group_0_wrap_2_streak
                                            }
                                        >
                                            {dailyStreak || "0"}
                                        </span>
                            ...
                            <div className={Container.fd_container_2}>
                                <div className={Input.fd_input_0}>
                                    {!isGuessed && (
                                        <div
                                            className={Input.fd_input_0_wrapper}
                                        >
                                            <input
                                                autoComplete="off"
                                                disabled={isGuessed}
