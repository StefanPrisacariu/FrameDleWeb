        ...
        <>
            ...
            <div className={Section.fd_section_0}>
                <div className={Container.fd_container_0}>
                    <div className={Header.fd_header_0}>
                    ...
                    <div className={Container.fd_container_5}>
                        ...
                        <p className={Text.fd_text_2_def}>
                            In <span className={Text.fd_text_2_link}>Daily</span> mode you have to guess today&apos;s
                            warframe from Digital Extreme&apos;s game &quot;Warframe&quot;. It changes every 24h. For
                            Daily mode you also need an internet connection.
                        </p>
                        <p className={Text.fd_text_2_def}>
                            Next warframe in: <TimerComponent />
                        </p>
                        <p className={Text.fd_text_2_def}>
                            While in <span className={Text.fd_text_2_link}>Endless</span> mode, you can play as much as
                            you want just by pressing the <span className={Text.fd_text_2_link}>New Warframe</span>{' '}
                            button to reset the game, please note that the Endless mode doesn&apos;t add to the Daily
                            mode&apos;s Streak. Also, the Endless mode doesn&apos;t require an internet connection, it
                        ...
                        <p className={Text.fd_text_2_def}>Here is the details of each of the properties columns:</p>

                        <p className="info-textLabel">Gender</p>
                        <p className={Text.fd_text_2_def}>Possible Values: Male, Female, Non Binary</p>
                        <p className="info-textLabel">Variant</p>
                        <p className={Text.fd_text_2_def}>Possible Values: Standard, Prime, Umbra</p>
                        <p className="info-textLabel">Aura Polarity</p>
                        <p className={Text.fd_text_2_def}>Possible Values: Madurai, Vazarin, Naramon, etc...</p>
                        <p className="info-textLabel">Progenitor Element</p>
                        <p className={Text.fd_text_2_def}>Possible Values: Impact, Radiation, Cold, etc...</p>
                        <p className="info-textLabel">Release Year</p>
                        <p className={Text.fd_text_2_def}>When the champion was released to be played.</p>

                        <p className={Text.fd_text_2_title}>Example</p>
                        <p className={Text.fd_text_2_def}>
                            Consider the correct answer is <span className={Text.fd_text_2_link}>Excalibur Prime</span>.
                            If you enter <span className={Text.fd_text_2_link}>Qorvex</span> these properties will
                            appear:
                        </p>
                        <div className="info-scroller">
                            <GuessRow
                                warframeGuess={initialWarframes.find(item => 'Qorvex' === item.name) as Warframe}
                                todayWarframe={
                                    initialWarframes.find(item => 'Excalibur Prime' === item.name) as Warframe
                                }
                            />
                        </div>
                        ...
                        <p className={Text.fd_text_2_def}>It is an exact match, they are both male.</p>
                        <p className="info-textLabel">
                        ...
                        <p className={Text.fd_text_2_def}>
                            It is not a match since Excalibur Prime&apos;s aura polarity is Madurai.
                        </p>
                        <p className="info-textLabel">
                        ...
                        <p className={Text.fd_text_2_def}>Excalibur Prime&apos;s Release year is before 2023</p>
                        <p className={Text.fd_text_2_def}>If you enter Excalibur Prime, here is what would come up:</p>
                        ...
                        <p className={Text.fd_text_2_def}>
                            ...
                            <span className={Text.fd_text_2_link}>support@framedle.org</span>. Your input helps us
                            improve and enhance the FrameDle experience for everyone.
                        </p>
                        <p className={Text.fd_text_2_def}>
                        ...
                        <button
                            ...
                            onClick={() => window.open('https://ko-fi.com/leokaiskarri')}
                        >
